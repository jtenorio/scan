    ...
    if(contador > 0){
        ...
        for(i=1;i<=contador;i++){
            ...
            html = html + '<tr>';
                ...
                html = html + '<td><input type="text" name="fechaPago[]" class="fecha" size="10" /></td>';
            html = html + '</tr>';
        }
        html = html + '</table>';
...
<?php
echo CHtml::form("ver", "post",array("id"=>"form11","name"=>"form11"));
?>


<h1>Mostrar Compras</h1>
<?php //echo "ID COMPRA".$idCompra; ?>
<div id="validacion">
...
<div class="contenido2">
  ...
  <div class="contenidoGrande">
    <?php
    echo CHtml::activeListBox($compra, 'idsustentotributario', Secuencialtransaccion::model()->buscaTipoComprobante($compra->idsecuencialtransaccion), array("size" => "1",'prompt'=>'Seleccionar','style'=>'width:220px;',"disabled" => "disabled"));
    ?>
  </div>
  <div class="separador"></div>
  <div class="contenidoPequeno"><strong>Ubicación en Form. 104</strong></div>
  <div class="contenidoPequeno">
    <?php echo CHtml::activeListBox($compra, 'ubicacionformulario', $ubicacionForm104, array("size" => "1",'prompt'=>'Seleccionar',"disabled" => "disabled"));?>
  </div>
...
<table width="100%" align="center">
    ...
    <tr>
        <td>Iva Bienes</td>
        <td><?php echo CHtml::activeTextField($compra, 'montobaseiva30', array("size" => "6","readonly" => "readonly")); ?></td>
    ...
    <tr>
        <td>Iva Servicios</td>
        <td><?php echo CHtml::activeTextField($compra, 'montobaseiva70', array("size" => "6","readonly" => "readonly")); ?></td>
    ...
    <tr>
        <td>Iva 100%</td>
        <td><?php echo CHtml::activeTextField($compra, 'montobaseiva100', array("size" => "6","readonly" => "readonly")); ?></td>
...
<table>
    ...
    <?php
        ...
        foreach($pago as $pagos){
            echo '<tr><td>'.$pagos['valor'].'</td><td>'.$pagos['saldo'].'</td><td>'.$pagos['fecha'].'</td></tr>';
        }
    ?>
</table>
</div>
...
?>
<input id="button_exit" type="submit" value="exit" name="button_exit">
