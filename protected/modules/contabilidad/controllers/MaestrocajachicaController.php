...
class MaestrocajachicaController extends Controller
{
                        ...
                        if(isset($_POST['Maestroasiento']))
                        {
                            ...
                            if(isset($session['detalle_asiento_temp'])
                                ...
                                if($model->save())
                                {
                                    ...
                                    ////////////////////////////////////////////////////////////////////////////////////////
                                    $this->redirect(array('maestrocajachica/admin',));
                                }
                            }else{
...
//		));
        ...
        $dataExistente = array();
          ...
          foreach($_POST as $field => $value)  {
              ...
              if(count($temp)==3 && $temp[0]=='abono'){
                  ...
                  //detalle del asiento
                  $detalleAs = $proveedor->razonsocial." AB/CANC";
    ...
    {         
         $compras = Compraingreso::getComprasCajaChica();
         ...
         foreach($compras->getData() as $compra)
         {
             ...
             $temp['razonSocial'] = $compra['razonsocial'];
             $temp['idProveedor'] = $compra['idproveedor'];
