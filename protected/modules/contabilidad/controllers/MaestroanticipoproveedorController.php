...
class MaestroanticipoproveedorController extends Controller
{
                ...
                // $this->performAjaxValidation($model);
                             ...
                             && !isset($session['detalle_asiento_temp']))
                     {
                        ...
                        if(isset($_POST['Maestroasiento']))
                        {
                            ...
                            //modelo de anticipos
                            $anticipos = new Anticipoproveedor;
                            ...
                            if(isset($session['detalle_asiento_temp'])
                                ...
                                {
                                     ////////////////////////////////////////////////////////
                                    //llenar los datos de la tabla de anticipos
                                    ////////////////////////////////////////////////////////


                                    $anticipos->idasiento = $model->idasiento;
                                    $anticipos->idempresa = 1;
                                    $anticipos->numeroegreso = $model->numerocomprobante;
                                    $anticipos->idproveedor = $_POST['idProveedor'];
                                    $anticipos->valoranticipo = $model->valormovimiento;
                                    $anticipos->fecha = date('Ymd');
                                    
                                    ////////////////////////////////////////////////////////
                                   
                                    if($movimientos->save() && $anticipos->save())
                                    {
                                    ...
                                    ////////////////////////////////////////////////////////////////////////////////////////
                                    $this->redirect(array('maestroanticipoproveedor/admin',));
                                }
                            }else{
	...
	public function actionUpdate($id)
	{
            ...
            $session->open();
                ...
                if(isset ($_GET['idProveedor']))
                {
                    ...
                    $rowAnticipo = Anticipoproveedor::getAnticipoByAsiento($model->idasiento)->getData();
                    $idProveedor = $rowAnticipo[0]->idproveedor;
                }
...
//		));
	...
	public function actionAdmin()
	{
		...
		$model=new Anticipoproveedor('search');
