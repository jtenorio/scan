...
<?php if($model->isNewRecord ){?>
    <script type="text/javascript">
        sendPage('null', '<?php echo Yii::app()->request->baseUrl; ?>/index.php/contabilidad/maestrocajachica/detalle', 'crearDetalleAsiento');
    </script>
<?php }else{?>
    <script type="text/javascript">
        sendPage('null', '<?php echo Yii::app()->request->baseUrl; ?>/index.php/contabilidad/maestrocajachica/detalle/edit/<?php echo $model->idasiento?>/inicia/1', 'crearDetalleAsiento');
    </script>
    <p><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/contabilidad/maestrocajachica/delete/id/<?php echo $model->idasiento?>">Anular Asiento</a></p>
<?php }$this->endWidget(); ?>	

    <script type="text/javascript">
        sendPage('null','<?php echo Yii::app()->request->baseUrl; ?>/index.php/contabilidad/maestrocajachica/compras','compras');
    </script>
