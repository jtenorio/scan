...
$this->menu=array(
	array('label'=>'Listado de Egresos', 'url'=>array('index')),
...
<h1>Egresos - Emisi&oacute;n de cheques</h1>
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'dataProvider'=>$model->getChequesVarios(1),
	'filter'=>$model,
	'columns'=>array(		
		'numeroasiento',		
		'fechacreacion',
		...
		*/
		array(
                'class'=>'CButtonColumn',
                'template' => '{update}',                         
                'updateButtonUrl'=>'Yii::app()->createUrl("/contabilidad/maestrocheques/update",  array("id" =>  $data["idasiento"]))',
		),
