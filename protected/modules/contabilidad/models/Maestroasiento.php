...
class Maestroasiento extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('numerodocumento, numeroasiento,  beneficiario, fechacreacion, iddocumento, idcomprobantecontable, valormovimiento, idempresa', 'required'),
			array('iddocumento, idcuentabancaria, idcomprobantecontable, idempresa, numeroasiento, numerodocumento,numerocomprobante', 'numerical','integerOnly'=>true),
            ...
            array('valormovimiento', 'numerical'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'referenciaadicional' => 'Referencia adicional',
			'asientocuadrado' => 'Asiento cuadrado',
			'idempresa' => 'Idempresa',
            'tipodecheque'=>'Tipo de cheque',
		);
	}
...
//        }
        ...
        public function getAsientos($idEmpresa)
        {
            /**
             * @var CDbCriteria
             */
            $criteria=new CDbCriteria;
            $criteria->addCondition("tipodecheque = 6");
        ...
        public function getChequesVarios($idEmpresa)
        {
            $criteria=new CDbCriteria;
            $criteria->compare('tipodecheque',4);
            $criteria->compare('idempresa',$idEmpresa);
         ...
         public function getPagoProveedor($idEmpresa)
        {
            $criteria=new CDbCriteria;
            $criteria->compare('tipodecheque',1);
            $criteria->compare('idempresa',$idEmpresa);
        ...
        public function getPagoCajaChica($idEmpresa)
        {
            $criteria=new CDbCriteria;
            $criteria->compare('tipodecheque',2);
            $criteria->compare('idempresa',$idEmpresa);
