...
class Tipodocumentocontable extends CActiveRecord
{
	...
	public function search()
	{
        ...
        public static function updateNumeroDocumento($idDocumento)
        {
            $actual = Tipodocumentocontable::model()->findByPk($idDocumento);
            $actual->numerodocumento = $actual->numerodocumento + 1;
            $actual->save();
        }
        
        public static function getNuevoNumeroDocumento($idDocumento)
        {
            $actual = Tipodocumentocontable::model()->findByPk($idDocumento);
            return $actual->numerodocumento;
        }
        
        public static function getTipoDocumentoById($idDocumento)
        {
            return $actual = Tipodocumentocontable::model()->findByPk($idDocumento);            
        }
}