...
class Proveedor extends CActiveRecord
{
	 ...
	 */
        public $consumidor_final='9999999999999';
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, tipodocumento, cuentacontableporpagar, cuentacontableanticipo, idtipoproveedor', 'numerical', 'integerOnly'=>true),
			...
			array('fax, autorizacionfactura', 'length', 'max'=>10),
                        array('autorizacionfactura', 'length', 'max'=>10,'min'=>6),
	...
	public function search()
	{
         ...
         */
      	public function verificaRuc($attribute, $params) {
            if (($this->tipodocumento!==3)&&($this->tipodocumento!==6)){
		if ($this->cedularuc!=$this->consumidor_final){
