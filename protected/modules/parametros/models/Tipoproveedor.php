...
/**
 * This is the model class for table "tipoproveedor".
 *
 * The followings are the available columns in table 'tipoproveedor':
 * @property integer $id
...
class Tipoproveedor extends CActiveRecord
{
	...
	{
		return array(
			'id' => MessageHandler::transformar('ID','Parametros','TipoProveedor'),
			'nombre' => MessageHandler::transformar('Nombre','Parametros','TipoProveedor'),
		);
	}
