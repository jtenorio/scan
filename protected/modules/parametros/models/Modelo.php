...
class Modelo extends CActiveRecord
{
	...
	{
		return array(
			'id' => MessageHandler::transformar('id','Parametros','Modelo'),
			'nombre' => MessageHandler::transformar('nombre','Parametros','Modelo'),
			'idempresa' => MessageHandler::transformar('idempresa','Parametros','Modelo'),
		);
	}
	...
	public function search()
	{
        ...
        public function buscaModelo($param,$limit=20){
