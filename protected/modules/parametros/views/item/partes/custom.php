...
?>
		...
		<?php echo CHtml::activeTextField($model_cstm,'numeroserie',array('size'=>50,'maxlength'=>50));
		...
		<?php echo CHtml::activeTextField($model_cstm,'ubicacion',array('size'=>60,'maxlength'=>120)); ?>
		
            <br>
            <label>Codigo Barras:</label>
		
		<?php echo CHtml::activeTextField($model_cstm,'codigobarras',array('size'=>60,'maxlength'=>150)); ?>
