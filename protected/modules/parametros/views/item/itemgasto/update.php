 ...
 */
?>
<h1><?php echo MessageHandler::transformar('UpdateTitle','Parametros','Item',array('{nombre}'=>$model->nombre)) ?></h1>
...
<?php echo $form->labelEx($model,'tipoproducto'); ?>
	...
	<?php echo $form->labelEx($model,'stockminimo'); ?>
        <?php echo $form->textField($model,'stockminimo',array('size'=>10,'maxlength'=>10)); ?>
...
//	));
 ...
 <br>
	...
	<?php $this->renderPartial('application.modules.parametros.views.item.partes.custom',compact('model_cstm')); ?>
