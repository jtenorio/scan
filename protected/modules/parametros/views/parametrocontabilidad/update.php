...
<h1><?php echo MessageHandler::transformar('UpdateTitle','Parametros','ParametroContabilidad',array('{nombre}'=>$model->idparametrocontabilidad)) ?></h1>
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<!--<br>-->
		...
		<?php
                 echo CHtml::textField('nombrecuentabancariapred', Cuentabancaria::model()->buscaNombre($model->idcuentabancariapred), array('readonly'=>true,'size'=>'35'));
