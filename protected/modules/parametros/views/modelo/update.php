 ...
 */
?>
<h1><?php echo MessageHandler::transformar('UpdateTitle','Parametros','Modelo',array('{nombre}'=>$model->nombre)) ?></h1>
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	$this->widget('HintWidget', array(
			'text' =>MessageHandler::transformar('nombre_tooltip','Parametros','Modelo'),
			'effect' => 'normal'
	));
	?>
	<br>
        ...
        <?php
	$this->widget('HintWidget', array(
			'text' =>MessageHandler::transformar('idempresa_tooltip','Parametros','Modelo'),
			'effect' => 'normal'
	));
	?>
	<br>
