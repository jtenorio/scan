 ...
 */
?>
<h1><?php echo MessageHandler::transformar('Title','Parametros','PeriodoContable'); ?></h1>
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	$this->widget('HintWidget', array(
     ...
     ?>
		...
		<?php echo $form->dropDownList($model,'mesnumero',$meses);// textField($model,'mesnumero',array('size'=>2,'maxlength'=>2)); ?>
	...
	$this->widget('HintWidget', array(
     ...
     ?>
		...
		<?php echo $form->dropDownList($model, 'idejercicio',CHtml::listData(
             EjercicioContable::model()->findAll(), 'id', 'ubicacion')); ?>
