        ...
        <tr>
            ...
            <td>
                <select id="optColaboracion" onchange="
                        switch(this.value){
                            case '1':
                                sendPage('null', '<?php echo Yii::app()->request->baseUrl;?>/index.php/crmColaboracion/llamada/create/id/<?php echo $id?>/dia/<?php echo $dia?>/mes/<?php echo $mes?>/anio/<?php echo $anio?>', 'colaboracion');
                                break;
                            case '2':
