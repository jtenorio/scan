...
<?php
echo CHtml::form("creardevolucioncompra", "post",array("id"=>"formDevolucionCompra","name"=>"formDevolucionCompra"));
?>
<h1>Registro de Devolución de Compras</h1>
<?php
if($validarPagado==1){
...
echo CHtml::hiddenField("idCompra", '', array("id" => "idCompra","readonly"=>"readonly"));
...
<div class="contenido2">
  ...
  <div class="contenidoGrande">
      <?php
        echo CHtml::activeListBox($compra, 'idtipocomprobante', array(),array(
            'size' => '1',
            'style'=>'width:220px;',
            'prompt' => 'Seleccionar',
            'ajax' => array(
  ...
  <div class="contenidoGrande">
    <?php
    echo CHtml::activeListBox($compra, 'idsustentotributario', array(), array("size" => "1",'prompt'=>'Seleccionar','style'=>'width:220px;'));
    ?>
  </div>
  <div class="separador"></div>
  ...
  <div class="separador"></div>
  <div class="contenidoPequeno"><strong>Compras</strong></div>
  <div class="contenidoPequeno">
    <?php echo CHtml::link('Buscar Compra','javascript:buscarCompra("'.CHtml::normalizeUrl(array('Compra/buscarAjaxCompra')).'");');?>
  </div>
...
<div class="contenido5">
    <?php
        $this->widget('GrillaWidget',array('text'=>'0','tipo'=>'devolucion'));
    ?>
...
<table width="100%">
    <tr>
        ...
        <td><?php echo CHtml::textField('txtDocumentoModificado', '',array('id'=>'txtDocumentoModificado','readonly'=>'readonly')); ?></td>
        <td>Fecha Emisión</td>
        <td><?php echo CHtml::textField('txtFechaEmision', '',array('id'=>'txtFechaEmision','readonly'=>'readonly')); ?></td>
        <td>Saldo Doc</td>
        <td><?php echo CHtml::textField('txtSaldoDoc', '',array('id'=>'txtSaldoDoc','readonly'=>'readonly')); ?></td>
    </tr>
</table>
<br/>
<table width="100%">
    <tr>
        ...
        <td>
        <?php
            echo CHtml::textField('txtEstab', '',array('id'=>'txtEstab','readonly'=>'readonly',"size" => "3"));
            echo CHtml::textField('txtPunto', '',array('id'=>'txtPunto','readonly'=>'readonly',"size" => "3"));
            echo "<strong>Secuen.</strong>";
            echo CHtml::textField('txtSecuencial', '',array('id'=>'txtSecuencial','readonly'=>'readonly',"size" => "7"));
        ?>
        </td>
        <td>No. Autorización</td>
        <td><?php echo CHtml::textField('txtNumAutorizacion', '',array('id'=>'txtNumAutorizacion','readonly'=>'readonly')); ?></td>
    </tr>
</table>
<br/>
<hr/>
