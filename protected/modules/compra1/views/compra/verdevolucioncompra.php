...
<?php
echo CHtml::form("verdevolucioncompra", "post",array("id"=>"formDevolucionCompra","name"=>"formDevolucionCompra"));
?>
<h1>Mostrar Devolución de Compras</h1>
...
echo CHtml::hiddenField("idCompra", $idCompra, array("id" => "idCompra","readonly"=>"readonly"));
echo CHtml::hiddenField("idMaestroAsiento", $idMaestroAsiento, array("id" => "idMaestroAsiento","readonly"=>"readonly"));
echo CHtml::hiddenField("idCompraCstm", $idCompraCstm, array("id" => "idCompraCstm","readonly"=>"readonly"));
...
<div class="contenido2">
  ...
  <div class="contenidoGrande">
    <?php
    echo CHtml::activeListBox($compra, 'idsustentotributario', Tipocomprobante::model()->buscaIdentiCredito($compra->idtipocomprobante), array("size" => "1",'disabled'=>'disabled','style'=>'width:220px;'));
    ?>
  </div>
  <div class="separador"></div>
...
<?php
    ...
    echo '<input id="button_save" type="submit" value="save" name="button_save">';
