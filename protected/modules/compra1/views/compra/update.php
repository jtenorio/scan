...
$cs->registerScriptFile(Yii::app()->baseUrl . '/js/validarCompraModificar.js', CClientScript::POS_HEAD);
...
<?php
echo CHtml::form("update", "post",array("id"=>"formUpdate","name"=>"formUpdate"));
?>
...
<div class="contenido1">
  ...
  <div class="contenidoGrande">
  <?php
    echo CHtml::textField("proveedor", Proveedor::model()->buscaRucNombre($compra->idproveedor), array("id" => "proveedor","size" => "50"));
...
<div class="contenido2">
  ...
  <div class="contenidoGrande">
    <?php
    echo CHtml::activeListBox($compra, 'idsustentotributario', Tipocomprobante::model()->buscaIdentiCredito($compra->idtipocomprobante), array("size" => "1",'prompt'=>'Seleccionar','style'=>'width:220px;'));
    ?>
  </div>
  <div class="separador"></div>
...
<div class="contenido5">
    <?php
        $this->widget('GrillaWidget',array('text'=>$idCompra,'tipo'=>'modificar'));
    ?>
</div>
...
<table width="100%" align="center">
    ...
    <tr>
        <td>Iva Bienes</td>
        <td><?php echo CHtml::activeTextField($compra, 'montobaseiva30', array("size" => "6","onchange"=>"calcularValorRentencionIva()")); ?></td>
        <td><?php echo CHtml::activeListBox($compra, 'porcentajeretencioniva30', $porcentajeIvas30, array("size" => "1",'prompt'=>'Seleccionar','style'=>'width:85px;'));?></td>
        ...
        <td>
            <?php echo CHtml::textField("base0_1", $base0_1, array("id" => "base0_1","size" => "6","onchange"=>"calcularValorRetenido()")); ?><br/>
            <?php echo CHtml::textField("base0_2", $base0_2, array("id" => "base0_2","size" => "6","onchange"=>"calcularValorRetenido()")); ?>
        </td>
        <td>
            <?php echo CHtml::textField("base12_1", $base12_1, array("id" => "base12_1","size" => "6","onchange"=>"calcularValorRetenido()")); ?><br/>
            <?php echo CHtml::textField("base12_2", $base12_2, array("id" => "base12_2","size" => "6","onchange"=>"calcularValorRetenido()")); ?>
        </td>
        <td>
            <?php echo CHtml::textField("base_no_objeto_1", $base_no_objeto_1, array("id" => "base_no_objeto_1","size" => "6","onchange"=>"calcularValorRetenido()")); ?><br/>
            <?php echo CHtml::textField("base_no_objeto_2", $base_no_objeto_2, array("id" => "base_no_objeto_2","size" => "6","onchange"=>"calcularValorRetenido()")); ?>
        </td>
        <td>
            <?php echo CHtml::textField("porcentaje_retencion_1", $porcentaje_retencion_1, array("id" => "porcentaje_retencion_1","size" => "6")); ?><br/>
            <?php echo CHtml::textField("porcentaje_retencion_2", $porcentaje_retencion_2, array("id" => "porcentaje_retencion_2","size" => "6")); ?>
        </td>
        <td>
            <?php echo CHtml::textField("valor_retenido_1", $valor_retenido_1, array("id" => "valor_retenido_1","size" => "6")); ?><br/>
            <?php echo CHtml::textField("valor_retenido_2", $valor_retenido_2, array("id" => "valor_retenido_2","size" => "6")); ?>
        </td>
        <td>
            <?php echo CHtml::textField("base_imponible_1", $base_imponible_1, array("id" => "base_imponible_1","size" => "6")); ?><br/>
            <?php echo CHtml::textField("base_imponible_2", $base_imponible_2, array("id" => "base_imponible_2","size" => "6")); ?>
        </td>
    </tr>
    <tr>
        <td>Iva Servicios</td>
        <td><?php echo CHtml::activeTextField($compra, 'montobaseiva70', array("size" => "6","onchange"=>"calcularValorRentencionIva()")); ?></td>
        <td><?php echo CHtml::activeListBox($compra, 'porcentajeretencioniva70', $porcentajeIvas70, array("size" => "1",'prompt'=>'Seleccionar','style'=>'width:85px;'));?></td>
        ...
        <td>
            <?php echo CHtml::textField("base0_3", $base0_3, array("id" => "base0_3","size" => "6","onchange"=>"calcularValorRetenido()")); ?><br/>
            <?php echo CHtml::textField("base0_4", $base0_4, array("id" => "base0_4","size" => "6","onchange"=>"calcularValorRetenido()")); ?>
        </td>
        <td>
            <?php echo CHtml::textField("base12_3", $base12_3, array("id" => "base12_3","size" => "6","onchange"=>"calcularValorRetenido()")); ?><br/>
            <?php echo CHtml::textField("base12_4", $base12_4, array("id" => "base12_4","size" => "6","onchange"=>"calcularValorRetenido()")); ?>
        </td>
        <td>
            <?php echo CHtml::textField("base_no_objeto_3", $base_no_objeto_3, array("id" => "base_no_objeto_3","size" => "6","onchange"=>"calcularValorRetenido()")); ?><br/>
            <?php echo CHtml::textField("base_no_objeto_4", $base_no_objeto_4, array("id" => "base_no_objeto_4","size" => "6","onchange"=>"calcularValorRetenido()")); ?>
        </td>
        <td>
            <?php echo CHtml::textField("porcentaje_retencion_3", $porcentaje_retencion_3, array("id" => "porcentaje_retencion_3","size" => "6")); ?><br/>
            <?php echo CHtml::textField("porcentaje_retencion_4", $porcentaje_retencion_4, array("id" => "porcentaje_retencion_4","size" => "6")); ?>
        </td>
        <td>
            <?php echo CHtml::textField("valor_retenido_3", $valor_retenido_3, array("id" => "valor_retenido_3","size" => "6")); ?><br/>
            <?php echo CHtml::textField("valor_retenido_4", $valor_retenido_4, array("id" => "valor_retenido_4","size" => "6")); ?>
        </td>
        <td>
            <?php echo CHtml::textField("base_imponible_3", $base_imponible_3, array("id" => "base_imponible_3","size" => "6")); ?><br/>
            <?php echo CHtml::textField("base_imponible_4", $base_imponible_4, array("id" => "base_imponible_4","size" => "6")); ?>
        </td>
    </tr>
    <tr>
        <td>Iva 100%</td>
        <td><?php echo CHtml::activeTextField($compra, 'montobaseiva100', array("size" => "6","onchange"=>"calcularValorRentencionIva()")); ?></td>
        <td><?php echo CHtml::activeListBox($compra, 'porcentajeretencioniva100', $porcentajeIvas100, array("size" => "1",'prompt'=>'Seleccionar','style'=>'width:85px;'));?></td>
        ...
        <td>
            <?php echo CHtml::textField("base0_5", $base0_5, array("id" => "base0_5","size" => "6","onchange"=>"calcularValorRetenido()")); ?><br/>
            <?php echo CHtml::textField("base0_6", $base0_6, array("id" => "base0_6","size" => "6","onchange"=>"calcularValorRetenido()")); ?>
        </td>
        <td>
            <?php echo CHtml::textField("base12_5", $base12_5, array("id" => "base12_5","size" => "6","onchange"=>"calcularValorRetenido()")); ?><br/>
            <?php echo CHtml::textField("base12_6", $base12_6, array("id" => "base12_6","size" => "6","onchange"=>"calcularValorRetenido()")); ?>
        </td>
        <td>
            <?php echo CHtml::textField("base_no_objeto_5", $base_no_objeto_5, array("id" => "base_no_objeto_5","size" => "6","onchange"=>"calcularValorRetenido()")); ?><br/>
            <?php echo CHtml::textField("base_no_objeto_6", $base_no_objeto_6, array("id" => "base_no_objeto_6","size" => "6","onchange"=>"calcularValorRetenido()")); ?>
        </td>
        <td>
            <?php echo CHtml::textField("porcentaje_retencion_5", $porcentaje_retencion_5, array("id" => "porcentaje_retencion_5","size" => "6")); ?><br/>
            <?php echo CHtml::textField("porcentaje_retencion_6", $porcentaje_retencion_6, array("id" => "porcentaje_retencion_6","size" => "6")); ?>
        </td>
        <td>
            <?php echo CHtml::textField("valor_retenido_5", $valor_retenido_5, array("id" => "valor_retenido_5","size" => "6")); ?><br/>
            <?php echo CHtml::textField("valor_retenido_6", $valor_retenido_6, array("id" => "valor_retenido_6","size" => "6")); ?>
        </td>
        <td>
            <?php echo CHtml::textField("base_imponible_5", $base_imponible_5, array("id" => "base_imponible_5","size" => "6")); ?><br/>
            <?php echo CHtml::textField("base_imponible_6", $base_imponible_6, array("id" => "base_imponible_6","size" => "6")); ?>
        </td>
    </tr>
</table>
...
<table width="100%" align="center">
    <tr>
        ...
        <td width="75px">
        <?php
            $retAutomatica = Establecimiento::model()->buscaRetencionAutomatica(1);
            if($retAutomatica==1){
                $numRetencion = Establecimiento::model()->buscaNumeroRetencion(1);
                echo CHtml::activeTextField($compra, 'secuencialretencion1', array("size" => "6","readonly" => "readonly"));
            }else{
                echo CHtml::activeTextField($compra, 'secuencialretencion1', array("size" => "6"));
            }
        ?>
        </td>
        ...
        <td>Fecha Emisión</td>
        <td><?php echo CHtml::activeTextField($compra, 'fecharetencion1', array("size" => "10","class" => "fecha")); ?></td>
    </tr>
</table>
<br/>
<hr/>
...
<table width="100%">
    <tr>
        ...
        <td>Tarjeta</td>
        <td><?php echo CHtml::activeListBox($compra, 'idtarjetacredito', $tarjetaCredito, array("size" => "1",'style'=>'width:180px;'));?></td>
    </tr>
</table>
<br/>
<table width="100%">
...
<table>
    ...
    <?php
        ...
        foreach($pago as $pagos){
            echo '<tr>
                    <td><input type="text" name="valorPago[]" value="'.$pagos['valor'].'" /></td>
                    <td><input type="text" name="saldoPago[]" value="'.$pagos['saldo'].'" /></td>
                    <td><input type="text" name="fechaPago[]" value="'.$pagos['fecha'].'" /></td>
                </tr>';
        }
    ?>
</table>
